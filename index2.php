...
<header>
        ...
        <h2> <img src="Images/download.jpeg" height="50px" width="50px" > SunShine Jewellary</h2>
...
<div class="top-buffer-updated" >
    <div class="container bg-dark text-light p-3 rounderd my-4" style="width:2600px;">
        <div class="d-flex align-items justify-content-between px-3">
            <h2>
                <a href="index2.php" class="text-white text-decoration-none">SunShine Jewellery</a>
    ...
    <div class="container mt-4 p-0">
            <table class="table table-hover text-center">
                <thead class="bg-dark text-light">
                    <tr>
                    <th width="10%" scope="col" class="rounded-start">Product.No.</th>
